...
XiiTuningPitchCircle {
	...
	*new { arg steps, tonic, mod, offset, drawInts, size, win, num;
		^super.new.initXiiTuningPitchCircle(steps, tonic, mod, offset, drawInts, size, win, num)
	}
	
	initXiiTuningPitchCircle { arg aSteps, aTonic, aMod, anOffset, aDrawInts, anSize, anWin, aNum;
		steps = aSteps ? 12;
		...
		scs= XiiTuningDiscs.new; // does the interval calcs
